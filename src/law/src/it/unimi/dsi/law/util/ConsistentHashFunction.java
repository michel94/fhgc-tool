...
public final class ConsistentHashFunction<T extends Comparable<? super T>> {
	...
	final protected ObjectSortedSet<Entry<Long, Object>> entrySet = replicae.entrySet();
	...
	public boolean add( final T bucket, final int weight ) {
		...
		final XorShift128PlusRandom random = new XorShift128PlusRandom( bucket.hashCode() );
	...
	public Object[] hash( long point, int n ) {
		...
		ObjectBidirectionalIterator<Entry<Long, Object>> i = replicae.entrySet().iterator( new AbstractLong2ObjectSortedMap.BasicEntry<Object>( point, null ) );
