...
/*
 *  Copyright (C) 2006-2015 Paolo Boldi, Roberto Posenato, Massimo Santini and Sebastiano Vigna
 *
...
public class KendallTauTest {
	...
	public void testRandom() {
		XorShift128PlusRandom XorShift128PlusRandom = new XorShift128PlusRandom( 0 );
		final double v0[] = new double[ 1000 ];
		final double v1[] = new double[ 1000 ];
		for( int i = v0.length; i-- != 0; ) {
			v0[ i ] = XorShift128PlusRandom.nextDouble();
			v1[ i ] = XorShift128PlusRandom.nextDouble();
		}
	...
	public void testRandomWithTies() {
		...
		final double v1[] = new double[ 1000 ];
		for( int i = v0.length; i-- != 0; ) {
			v0[ i ] = XorShift128PlusRandom.nextInt( 10 );
			v1[ i ] = XorShift128PlusRandom.nextInt( 10 );
		}
		double expResult = compute( v0, v1 );
		double result = KendallTau.INSTANCE.compute( v0, v1 );
		assertEquals( expResult, result, 1E-9 );
